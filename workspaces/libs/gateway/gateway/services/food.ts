...
export namespace Product {
  ...
  export type DeleteRequest = Gateway.IRequest<{ id: string }>;
  ...
  export type GetRequest = Gateway.IRequest<{ id: string } | { name: string }>;

  // LIST ----------------------------------------------------------------------------------
  export type ListErrors = Gateway.CommonExceptions;
  export type ListRequest = Gateway.IRequest<void>;
